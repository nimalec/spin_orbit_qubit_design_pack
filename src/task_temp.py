...
class MagenticAnisotropySphereFlow:
    ...
    def __init__(self, workdir, npoints, kgrid, nbands, nodes, ppn, ref_orient, ldaul, magmom, Uparam, Jparam, encut, potcar_path, struct_path, ismear, name ="mae_calc", time_cl="12:00:00", time_ncl="01:40:00", sigma=0.2, nelect=None, cl_dir=None):
